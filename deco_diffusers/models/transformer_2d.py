...
from src.models.transformer.dit_c2i_deco import PixNerDiT as DeCoC2IBackbone
from src.models.transformer.dit_t2i_deco import PixNerDiT as DeCoT2IBackbone
...
class DeCoTransformer2DModel(ModelMixin, ConfigMixin):
    ...
    def __init__(
        self,
        conditioning_type: str = "class",  # class | text
        in_channels: int = 4,
        patch_size: int = 2,
        # c2i args
        num_groups: int = 12,

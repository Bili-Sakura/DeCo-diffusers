...
from diffusers.models.transformers.dit_c2i_deco import PixNerDiT as DeCoC2IBackbone
from diffusers.models.transformers.dit_t2i_deco import PixNerDiT as DeCoT2IBackbone
